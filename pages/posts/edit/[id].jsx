        ...
        <form onSubmit={onSubmit} className="w-full">
          ...
          <div className="mb-5 mr-auto block w-full">
            <PostInput
              ...
              label="What Tags/Tech did you use?"
              id="tech-stack"
              placeholder="Portrait, Wildlife, Traditional, MongoDB, Socket.io"
              value={techStack}
          ...
          <div className="mb-5 mr-auto grid md:grid-cols-2 gap-4 w-full">
            <PostInput
              Icon={LinkIcon}
              label="Deployed Creation URL"
              id="live-demo"
              placeholder="https://drive.xyz"
              value={liveDemo}
