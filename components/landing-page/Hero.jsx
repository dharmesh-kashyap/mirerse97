          ...
          <div className="mt-16 mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Mirerse, for the</span>
                <span className="block text-pink-600">developers and Designers</span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                Discover creative Designers and developers across the globe. A
                portal for you to share your artwork and projects and get inspired for free.
              </p>
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              src="https://imgur.com/NShF7jJ.png"
              width={1000}
              height={1000}
            />
          </motion.div>
